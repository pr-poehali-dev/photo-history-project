...
const TIMELINE_DATA = [
  ...
  },
  {
    ...
    image: "https://cdn.poehali.dev/files/510261c3-e09a-4abd-9e77-cb23d2ff3ab1.jpg",
    imageCaption: "Лев Толстой. Прокудин-Горский, Ясная Поляна, 1908",
  ...
  },
  {
    ...
    photographer: "Евгений Халдей",
    nationality: "СССР",
    description:
      "2 мая 1945 года Халдей поднялся на крышу Рейхстага и снял советских солдат, водружающих красное знамя над поверженным Берлином. Этот снимок облетел весь мир и стал символом победы над фашизмом. Флаг для съёмки Халдей сшил заранее из красных скатертей.",
    quote: "Я хотел запечатлеть момент, который войдёт в историю навсегда.",
    image: "https://cdn.poehali.dev/files/25d817b7-0ef1-423c-9045-95f94618df4e.jpg",
    imageCaption: "Знамя Победы над Рейхстагом. Евгений Халдей, Берлин, 1945",
    imageNote: "Один из самых узнаваемых снимков XX века",
    type: "documentary",
    featured: true,
  },
  {
